...
HISTORICAL_MODEL_RUN_KEYS = (
    ...
    "deepseek-v4-pro-run-variant-02",
    ...
    "grok-4.20-0309-non-reasoning-run-variant-02",
    "grok-4.20-0309-reasoning-run-variant-01",
    "grok-4.20-0309-reasoning-run-variant-02",
    "grok-4.20-0309-reasoning-run-variant-03",
...
def test_claude_fable_variants_use_effort_fallbacks_and_web_search():
    ...
    assert high.slug == "claude-fable-5-high-web-search-code-execution-128k"
    assert high.options == {
        **shared,
        "output_config": {"effort": "high"},
        "tools": [
